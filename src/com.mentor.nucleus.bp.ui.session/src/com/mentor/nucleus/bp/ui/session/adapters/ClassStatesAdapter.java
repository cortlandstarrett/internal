...
//======================================================================
//
// File: com/mentor/nucleus/bp/ui/session/adapters/ClassStatesAdapter.java
//
 ...
 * </p>
 */
public class ClassStatesAdapter implements ITreeContentProvider {
	static ClassStatesAdapter classstatesadapter = null;
	/**
	 * Returns the adapters singleton instance. If this
	 * is the first time, the instance is created.
	 */
	public static ClassStatesAdapter getInstance() {
		if (classstatesadapter == null) {
			classstatesadapter = new ClassStatesAdapter();
		}
		return classstatesadapter;
	}
	/**
    ...
    _c result13 = (StateMachineState_c)arg);
    if (result13 != null) {
      return result13;
    }
    return null;
