...
//======================================================================
//
// File: com/mentor/nucleus/bp/ui/session/adapters/PendingeventsAdapter.java
//
...
// class PendingEvent_c from the tree viewer and the hierarchy
// it imposes.
//
...
/**
 * This file adapts the meta-model entity; 'PendingEvent_c'
 ...
 * </p>
 */
public class PendingeventsAdapter implements ITreeContentProvider {
	static PendingeventsAdapter pendingeventsadapter = null;
	/**
	 * Returns the adapters singleton instance. If this
	 * is the first time, the instance is created.
	 */
	public static PendingeventsAdapter getInstance() {
		if (pendingeventsadapter == null) {
			pendingeventsadapter = new PendingeventsAdapter();
		}
		return pendingeventsadapter;
	}
	/**
	...
	public Object getParent(Object arg) {
		Instance_c result12 = Instance_c
				.getOneI_INSOnR2935((PendingEvent_c) arg);
		if (result12 != null) {
			return result12;
		}
		return null;
