...
//======================================================================
//
// File: com/mentor/nucleus/bp/ui/session/adapters/DomainsAdapter.java
//
...
public class DomainsAdapter implements ITreeContentProvider {
	...
	public Object getParent(Object arg) {
		SystemModel_c result1 = SystemModel_c.getOneS_SYSOnR28(Domain_c
				.getOneS_DOMOnR2948(ComponentInstance_c
						.getOneI_EXEOnR2948((Domain_c) arg)));
		if (result1 != null) {
			return result1;
		}
		return null;
	...
	public Object[] getChildren(Object arg) {
		int resultSize = 0;
		_c[] classes_2948_0 = ComponentInstance_c
				.getManyI_EXEsOnR2948((Domain_c) arg);

		resultSize += classes_2948_0.length;
		FunctionPackage_c[] functionpackages_2948_1 = FunctionPackage_c
				.getManyS_FPKsOnR29(Domain_c
						.getManyS_DOMsOnR2948(ComponentInstance_c
								.getManyI_EXEsOnR2948((Domain_c) arg)));

		SessionExplorerContentProvider.sort(functionpackages_2948_1);
		resultSize += functionpackages_2948_1.length;
		Object[] result = new Object[resultSize];
		int count = 0;
		for (int i = 0; i < classes_2948_0.length; i++) {
			result[count] = classes_2948_0[i];
			count++;
		}
		for (int i = 0; i < functionpackages_2948_1.length; i++) {
			result[count] = functionpackages_2948_1[i];
			count++;
		}
		return result;
	}
	...
	public boolean hasChildren(Object arg) {
		...
		if (functionpackages_2948_1.length > 0)
			return true;
		return false;
	}
}
