...
INSERT INTO T_TNS VALUES (64, '', 'C_PP',  '', 'Name', '', 'Parameters', true);
...
INSERT INTO T_TPS VALUES (70,64, '->SPR_PEP[R4503]->C_EP[R4501]->C_PP[R4006]', '', '', true);
INSERT INTO T_TPS VALUES (72,64, '->SPR_PEP[R4503]->C_EP[R4501]->C_PP[R4006]', '', '', true);
INSERT INTO T_TPS VALUES (69,64, '->SPR_REP[R4502]->C_EP[R4500]->C_PP[R4006]', '', '', true);
INSERT INTO T_TPS VALUES (71,64, '->SPR_REP[R4502]->C_EP[R4500]->C_PP[R4006]', '', '', true);
...
INSERT INTO T_TPS VALUES (78,70, '->CL_IIR[R4703]->C_IR[R4701]->C_P[R4009]->SPR_PEP[R4501]->SPR_PO[R4503]', '', '', true);
INSERT INTO T_TPS VALUES (78,72, '->CL_IIR[R4703]->C_IR[R4701]->C_P[R4009]->SPR_PEP[R4501]->SPR_PS[R4503]', '', '', true);
INSERT INTO T_TPS VALUES (79,69, '->CL_IIR[R4703]->C_IR[R4701]->C_R[R4009]->SPR_REP[R4500]->SPR_RO[R4502]', '', '', true);
INSERT INTO T_TPS VALUES (79,71, '->CL_IIR[R4703]->C_IR[R4701]->C_R[R4009]->SPR_REP[R4500]->SPR_RS[R4502]', '', '', true);
