...
import com.mentor.nucleus.bp.debug.test.SVXVerifierTest;
...
*/
public class SVXVerifierTestSuite extends TestSuite {
	...
	public static Test suite() throws CoreException {
		return new SVXVerifierTestSuite();
	}
	
	/**
	 * Construct the test suite.
	 */
	public SVXVerifierTestSuite() throws CoreException {
		...
		addTest(new TestSuite(SVXVerifierTest.class));
