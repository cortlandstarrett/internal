...
function create_build {
    ...
    # TODO - SKB, re-enable - ./configure_external_dependencies.sh ${branch} ${git_repo_root} ${build_dir} ${build_type} > ${log_dir}/configure_externals.log 2>&1
    ...
    #    TODO - add back in copying the built plug-in zip to a publish location, or wait and just use the better option, an update site.
    #    When added back, add back in the variable declarations below where main starts.
...
# TODO - release_base="/arch1/products/tiger/releases"
# TODO - release_drop="${release_base}/${branch}"
...
# TODO - server="tucson.wv.mentorg.com"
# TODO - rsh="ssh"
